...
console.log("------------------05------------------")
let famous_person:string="Rumi said"
let message:string="Do not feel lonely, the entire universe is inside you."
console.log(famous_person+", "+message)
console.log("------------------06------------------")
let m_name:string="\tMahad here....\n"
console.log(m_name)
console.log("------------------07------------------")
console.log(6+2)
console.log(10-2)
